...
class Citas
{
    ...
    function eliminarCita($id)//Aquí puede haber un error
    {
        $SQL_Eli_Cita =
            " DELETE FROM citas
				WHERE id = $id;
    ...
    {
        $SQL_Bus_Cita =
            "SELECT id, nombrepa, fechacita, horacita, motivocita
    ...
    function modificarCita($citas, $nombrePa, $fechaCita, $horaCita, $motivoCita)
    {
        $SQL_Act_Cita =
            "UPDATE citas
          SET 
    ...
    function buscarCita($id)//Aquí puede haber un error
    {
        $SQL_Bus_Cita =
    ...
    {
        $SQL_Bus_Cita =
            "SELECT COUNT(id) AS total FROM citas;";
