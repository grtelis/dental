    ...
    <div class="row mb-5">
      ...
      <div class="table-responsive">
         ...
         echo '<nav aria-label="Page navigation example">
          ...
          echo '">
                  <a class="page-link" role="button" onclick="consultarCitas(' . $anterior . ')" aria-label="Previous">
         ...
         echo '"><a class="page-link" role="button" onclick="consultarCitas(' . $i . ')">' . $i . '</a></li>';
        ...
        echo '">
        <a class="page-link" role="button" onclick="consultarCitas(' . $siguiente . ')" aria-label="Next">
