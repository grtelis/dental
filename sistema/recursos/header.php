        ...
        <li class="nav-item">
         ...
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" id="btn_prove" href="#">Proveedores</a></li>
            <li><a class="dropdown-item" id="btn_articulos">Artículos</a></li>
            <li><a class="dropdown-item" id="btn_mobi" href="#">Mobiliario</a></li>
          </ul>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="btn_usuarios" href="#">Usuarios</a>
        </li>
        <li class="nav-item">
